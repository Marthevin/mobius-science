...
5. Execute only the session-local source. Keep generated PDFs, figures, result tables, and QA artifacts in the session workspace.
...
- the final PDF hash checked by the quality gate.

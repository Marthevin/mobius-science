...
> 💡 **[AIPOCH Open-Science v0.30.2 released](https://github.com/aipoch/open-science/releases/latest)** _(last updated September 2026)_. AIPOCH Open-Science v0.30.2 is a stability release: Windows R runtimes recover reliably (conda startup, executable resolution, kernel recovery, and verified pip entry points), notebook same-turn inputs replay correctly, and reviewer corrections keep their context across linked feedback. Literature imports separate PubMed author surnames from initials and catch retraction relationships, connectors tighten Ensembl, VEP, Reactome, UCSC, and gnomAD behavior, and DeepSeek V4.1 Flash joins the model catalog. See the [latest release notes](https://github.com/aipoch/open-science/releases/latest) for full details.

...
describe('RemoteSessionPairingManager', () => {
  ...
  it('grants temporary access without allowing the browser to manage pairing', async () => {
    ...
    expect(firstResponse.body()).toContain('data-icon-layer="infinity-cloud"')
    expect(firstResponse.body()).toContain('<div class="brand-name">Mobius Science</div>')
    ...
    expect(firstResponse.body()).toContain('Mobius Science → Settings → Remote')
